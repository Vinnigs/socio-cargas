...
@section('titulo', 'Minha Empresa - Fretes | Sócio Caminhoneiro')
    ...
    <div id="container">
        <div class="aside-wrapper">
            <aside class="menu">
                ...
                <a href="{{route('minhaempresa.fretes')}}" class="menu-item-active menu-item">
        ...
        <section class="my-fretes">
            ...
            <ul class="fretes-list">
                ...
                @if(count($fretesEmProgresso) > 0)
                    <p style="margin-top: 32px">Fretes em Progresso:</p>
                    ...
                    @endforeach
                @else
                    <li><p>Você não possui fretes em andamento no momento.</p></li>
                @endif
            </ul>
            <ul class="fretes-list">

                @if(count($fretesAtivos) > 0)
                    <p style="margin-top: 32px">Fretes Aprovados:</p>
                        ...
                        <li class="fretes-list-item">
                            <div class="frete-wrapper">
                                <div class="frete-container-top">
                                    ...
                                    <p>{{$frete->status == 0 ? 'Pendente' : ($frete->status == 1 ? 'Aprovado' : ($frete->status == 2 ? 'Em andamento' : ($frete->status == 3 ? 'Concluído' : ($frete->status == 98 ? 'Reprovado' : ($frete->status == 99 ? 'Cancelado' : 'Status inexistente')))))}}</p>
                                </div>
                                <div class="frete-container-bottom">
                                    <div class="frete-container-bottom-type-product">
                                        <img src="/assets/img/material-block-black.svg" alt="">
                    ...
                    @endforeach
                @else
                    <li><p>Você não possui fretes ativos no momento.</p></li>
                @endif
            </ul>
            <ul class="fretes-list">

                @if(count($fretesPendentes) > 0)
                    <p style="margin-top: 32px">Fretes em Análise:</p>
                    @foreach($fretesPendentes as $frete)
                        <li class="fretes-list-item">
                            <div class="frete-wrapper">
                                ...
                                <div>
                                    <p class="frete-value">R$ {{$frete->preco}}</p>
                                    <a href="{{route('fretes.show', $frete->id)}}" style="font-size: 14px;">Ver Frete</a><br>
                                    <a href="{{route('empresa.frete.edit', $frete->id)}}" style="font-size: 14px;">Editar</a>
                                </div>
                    ...
                    @endforeach
                @else
                    <li><p>Você não possui fretes em análise no momento.</p></li>
                @endif
            </ul>
        </section>
    </div>
