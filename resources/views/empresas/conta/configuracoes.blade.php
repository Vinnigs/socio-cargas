...
@section('titulo', 'Configuração Empresa | Sócio Caminhoneiro')
...
<main>
    <div id="container">
        <div class="aside-wrapper">
            <aside class="menu">
                <a href="perfil-caminhoneiro.html" class="menu-item">
                ...
                <a href="perfil-caminhoneiro-pendentes.html" class="menu-item">
        ...
        <section class="my-fretes">
            ...
            <form class="dados-form">
                <div class="dados-form-info">
                    <h3 class="dados-form-title">Informações do perfil</h3>
                    <div class="form-inputs">
                        <div class="form-inputs-container">
                            <label for="perfil-name">Nome</label>
                            <input value="Lucas Ricardo" type="text" name="perfil-name" id="perfil-name">
                        </div>
                        <div class="form-inputs-container">
                            <label for="perfil-name">Sobrenome</label>
                            <input value="Barbosa" type="text" name="perfil-name" id="perfil-name">
                        </div>
                    </div>

                    <div class="form-inputs">
                        <div class="form-inputs-container">
                            <label for="perfil-date">Data de Nascimento</label>
                            <input value="2003-10-16" type="date" name="perfil-date" id="perfil-date">
                        </div>
                        <div class="form-inputs-container form-img-perfil-container">
                            <label for="perfil-img">Imagem</label>
                            <div class="form-img-perfil-container-wrapper">
                                <img id="open-file-input" class="perfil-img-content"
                                    src="./assets/img/arrow-numbers.png" alt="">
                                <div class="form-img-perfil-container-wrapper-hover">
                                    <i class="ph ph-camera"></i>
                                </div>
                            </div>
                            <input accept="image/png, image/jpeg" multiple type="file" name="perfil-img"
                                id="perfil-img" class="hidden-input">
                        </div>
                    </div>

                    <div class="form-inputs">
                        <div class="form-inputs-tel">
                            <label for="perfil-tel">Telefone</label>
                            <input value="(11) 99765-8567" type="tel" name="perfil-tel" id="perfil-tel">
                            <p>Digite junto com o DDD</p>
                        </div>
                    </div>
                </div>

                <div class="dados-form-login">
                    <div class="dados-form-login-email dados-form-info">
                        <h3 class="dados-form-title">E-mail</h3>
                        <div class="form-inputs">
                            <div class="form-inputs-container">
                                <label for="perfil-email">Endereço de E-mail</label>
                                <input value="lucasricardo@gmail.com" type="email" name="perfil-email"
                                    id="perfil-email">
                            </div>
                        </div>

                        <div class="email-notifications-btn">
                            <label class="switch">
                                <span class="switch-text">Receber promoções no E-mail</span>
                                <div class="switch-wrapper">
                                    <input class="switch-wrapper-btn" type="checkbox" name="email-notifications">
                    ...
                    <div class="dados-form-login-password dados-form-info">
                        <h3 class="dados-form-title">Senha</h3>
                        <div class="form-inputs">
                            <div class="form-inputs-container">
                                <label for="perfil-password">Redefinir senha</label>
                                <input value="123123123" type="password" name="perfil-password" id="perfil-email">
                            </div>
                        </div>
                    </div>
                </div>

                <div class="dados-form-truck dados-form-info">
                    <h3 class="dados-form-title">Informações do veículo</h3>
                    <div class="form-inputs">
                        <div class="form-inputs-container">
                            ...
                            <div class="select">
                                <div id="category-select">
                                    <label for="options-view-button1">Veículo</label>
                                    <input type="checkbox" id="options-view-button1">

                                    <div id="select-button" class="select-button-general">
                                ...
                                <ul id="options">
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category"
                                            value="so-cavalo" data-label="Só Cavalo">
                                        <span class="label-selected-form">Só Cavalo</span>
                                        <i class="ph ph-check"></i>
                                    </li>
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category"
                                            value="cavalo-carreta" data-label="Cavalo/Carreta">
                                    ...
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category"
                                            value="bi-truck" data-label="Bi-Truck">
                                        <span class="label-selected-form">Bi-Truck</span>
                                        <i class="ph ph-check"></i>
                                    </li>
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category" value="toco"
                                            data-label="Toco">
                                        <span class="label-selected-form">Toco</span>
                                        <i class="ph ph-check"></i>
                                    </li>
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category" value="3-4"
                                            data-label="3/4">
                                        <span class="label-selected-form">3/4</span>
                                        <i class="ph ph-check"></i>
                                    </li>
                                    <li class="option">
                                        <input class="form-input-radio" type="radio" name="category" value="VUC"
                                            data-label="VUC">
                        ...
                        <div class="form-inputs-container">
                            ...
                            <input value="Volvo" type="text" name="vehicle-marca" id="vehicle-marca">
                        </div>
                    </div>
                    <div class="form-inputs">
                        <div class="form-inputs-container">
                            <label for="vehicle-type">Modelo</label>
                            <input value="Caminhão Pesado" type="text" name="vehicle-type" id="vehicle-type">
                        </div>
                        <div class="form-inputs-container">
                            <label for="vehicle-year">Ano</label>
                            <input value="2017" type="number" name="vehicle-year" id="vehicle-year">
                        </div>
                    </div>
                    <div class="form-inputs">
                        <div class="form-inputs-container">
                            <label for="vehicle-bau">Báu</label>
                            <input value="Sider" type="text" name="vehicle-bau" id="vehicle-bau">
                        </div>
                    </div>
                </div>
                <div class="btn-wrapper">
                    <button class="regular-btn" type="submit">Enviar alterações</button>
                </div>
            </form>
...
@push('styles')
    ...
    <link rel="stylesheet" href="/assets/css/perfil-caminhoneiro-pessoais.css">
...
@push('scripts')
    ...
    <script defer src="/assets/js/img-switch.js"></script>
@endpush
