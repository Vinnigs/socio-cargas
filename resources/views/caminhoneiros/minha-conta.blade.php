    ...
    <div id="container">
        <div class="aside-wrapper">
            <aside class="menu">
                <a href="{{route('site.minhaconta')}}" class="menu-item-active menu-item">
                    ...
                    <p>Frete em andamento</p>
                </a>
                <a href="{{route('caminhoneiro.fretes.pendentes')}}" class="menu-item">
                ...
                <a href="{{route('caminhoneiro.fretes.historico')}}" class="menu-item">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="{{route('caminhoneiro.sair')}}" class="menu-item">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <section class="my-fretes">
            <div class="my-fretes-top" style="height: 78px">
                <h3>Frete em andamento</h3>
                <p>{{$caminhoneiro->candidaturas == 0 ? 'Você não possui candidaturas disponíveis, gostaria de aumentar as candidaturas?' : ($caminhoneiro->candidaturas == 1 ? 'Você possui '.$caminhoneiro->candidaturas.' candidatura disponível.' : 'Você possui '.$caminhoneiro->candidaturas.' candidaturas disponíveis.')}}</p>
            </div>
            <ul class="fretes-list">
                @if(count($freteAndamento) > 0)<a class="candidatar-link-disabled"><img src="/assets/img/formulario-svg.svg" alt=""> <span id="hora" dataCriado="{{$frete->updated_at}}" dataFinal="{{auth()->user()->caminhoneiros->assinatura == 'bronze' ? '24' : (auth()->user()->caminhoneiros->assinatura == 'ouro' ? '12' : '')}}"></span></a>
                    @foreach($freteAndamento as $frete)
