    ...
    <div id="container">
        <div class="aside-wrapper">
            <aside class="menu">
                ...
                <a href="{{route('caminhoneiro.fretes.pendentes')}}" class="menu-item-active menu-item">
        ...
        <section class="my-fretes">
            ...
            <ul class="fretes-list">
                @if(count($fretesPendentes) > 0)
                    ...
                    @endforeach
                @else
                    <li><p>Você não se candidatou a nenhum frete, <a href="{{route('fretes.index')}}">clique aqui para ver os fretes disponíveis.</a></p></li>
                @endif
