...
@section('titulo', 'Minha Conta | Fretes Pendentes')
    ...
    <div id="container">
        <div class="aside-wrapper">
            <aside class="menu">
                ...
                <a href="{{route('caminhoneiro.fretes.historico')}}" class="menu-item-active menu-item">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <section class="my-fretes">
            ...
            <ul class="fretes-list">
                @if(count($fretesHistorico) > 0)
                    ...
                    @endforeach
                @else
                    <li><p>Você não foi atribuído a nenhum frete, <a href="{{route('fretes.index')}}">clique aqui para ver os fretes disponíveis.</a></p></li>
                @endif
