    ...
    <ul class="fretes-list">
        ...
        <li class="flex gap-10 items-center justify-between py-8 border-b-2 border-zinc-300">
            <div class="flex gap-6">
                <img width="50" height="50" src="/assets/img/empresas/{{$empresa->imagem}}" alt="" class="foto-cam">
            ...
            <div class="flex gap-10">
                <a href="{{ route('admin.empresas.edit', $empresa->slug) }}">Editar</a>
                <a href="{{ route('empresas.show', $empresa->slug) }}" target="_blank">Ver mais</a>
            </div>
        </li>
        @endforeach
    </ul>
